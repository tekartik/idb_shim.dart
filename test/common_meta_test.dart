...
final IdbObjectStoreMeta idbSimpleObjectStoreMeta = new IdbObjectStoreMeta(STORE_NAME, null, true);

final IdbObjectStoreMeta idbObjectStoreMeta1 = new IdbObjectStoreMeta("name", "my_key", true);
final IdbObjectStoreMeta idbObjectStoreMeta1Same = new IdbObjectStoreMeta("name", "my_key", true);
final IdbObjectStoreMeta idbObjectStoreMeta2 = new IdbObjectStoreMeta("name", "my_key", false);
final IdbObjectStoreMeta idbObjectStoreMeta3 = new IdbObjectStoreMeta("name", null, true);
final IdbObjectStoreMeta idbObjectStoreMeta4 = new IdbObjectStoreMeta("other_name", "my_key", true);
final List<IdbObjectStoreMeta> idbObjectStoreMetas = [idbObjectStoreMeta1, idbObjectStoreMeta2, idbObjectStoreMeta3];
...
IdbIndexMeta idbIndexMeta5 = new IdbIndexMeta("other_name", "my_key", true, true);
final List<IdbIndexMeta> idbIndexMetas = [idbIndexMeta1, idbIndexMeta2, idbIndexMeta3, idbIndexMeta4, idbIndexMeta5];
